...
create_graph6("sys-diskfree", "images/d-diskfree-1w.png", "-1w", "/        ","/dev     ","/run     ","/run/lock","/run/shm ","/boot    ", "use %", "AVERAGE", $width, $height, $coldfl1, $coldfa1, $coldfl2, $coldfa2, $coldfl3, $coldfa3, $coldfl4, $coldfa4, $coldfl5, $coldfa5, $coldfl6, $coldfa6);
create_graph6("sys-diskfree", "images/d-diskfree-1m.png", "-1m", "/        ","/dev     ","/run     ","/run/lock","/run/shm ","/boot    ", "use %", "AVERAGE", $width, $height, $coldfl1, $coldfa1, $coldfl2, $coldfa2, $coldfl3, $coldfa3, $coldfl4, $coldfa4, $coldfl5, $coldfa5, $coldfl6, $coldfa6);
...
create_graph1("sys-ping", "images/d-ping-1d.png", "-1d", "Ping",    "ms",      "AVERAGE", $width, $height, $colpingline, $colpingarea);
create_graph1("sys-ping", "images/d-ping-1w.png", "-1w", "Ping",    "ms",      "AVERAGE", $width, $height, $colpingline, $colpingarea);
create_graph1("sys-ping", "images/d-ping-1m.png", "-1m", "Ping",    "ms",      "AVERAGE", $width, $height, $colpingline, $colpingarea);
...
echo "<td><img src='images/d-cputemp-1d.png'></td>";
echo "<td><img src='images/d-cputemp-1w.png'></td>";
echo "<td><img src='images/d-cputemp-1m.png'></td>";
echo "</tr>";
echo "<tr><td>Memory</td></tr>";
echo "<tr style='background:#F4F8F8;'>";
#echo "<td><img src='images/d-mem-free-1h.png'></td>";
echo "<td><img src='images/d-memfree-1d.png'></td>";
echo "<td><img src='images/d-memfree-1w.png'></td>";
echo "<td><img src='images/d-memfree-1m.png'></td>";
echo "</tr>";
echo "<tr><td>Storage</td></tr>";
echo "<tr>";
#echo "<td><img src='images/d-disk-free-1h.png'></td>";
echo "<td><img src='images/d-diskfree-1d.png'></td>";
echo "<td><img src='images/d-diskfree-1w.png'></td>";
echo "<td><img src='images/d-diskfree-1m.png'></td>";
echo "</tr>";
